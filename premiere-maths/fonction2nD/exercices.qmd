...
- $(I_0)\,:\,(5x+3)(1-2x) > 0$
- $(I_1)\,:\,\dfrac{(5x + 3)(2x-1)}{x^2 - 4} < 0$
- $(I_2)\,:\,16a^4-9  < 0$
- $(I_3)\,:\,\dfrac{3x - 16}{5x - 2} \geqslant 3x + 8$
:::
...
4. En utilisant la forme la plus adaptée de $f$  :
   1. Calculer $f(0)$, $f(\sqrt{3})$ et $f\left(\dfrac{5}{12}\right)$.
...
2. On considère $\varphi =\dfrac{1+\sqrt{5}}{2}$
   ...
   3. En déduire que l'autre racine est $-\dfrac{1}{\varphi}$
...
$$(E_1):\, x^2+3x+2=5(x+1) \et (E_2)\,:\, \dfrac{2}{x^2+3x+2} =\dfrac{1}{x+2}$$
:::
...
- $(E_1)\,:\, -\dfrac{-2x}{x^2+1} =3$
- $(E_2)\,:\, \dfrac{3}{x} - \dfrac{1}{2x-1} = 2$
- $(E_3)\,:\, \dfrac{3}{x^2} = \dfrac{1}{2x} +1$
- $(E_4)\,:\, x^3-x^2+4x=0$
- $(E_5)\,:\, \dfrac{6x^2-13x+5}{2x-1}=0$
- $(E_6) \,:\,\dfrac{1}{x} + \dfrac{2}{x+1} = \dfrac{3}{x-1}$
:::
...
2. Soit $r \in \mathbb{R}$. Montrer que si $r$ est une racine de $f$ alors $\dfrac{1}{r}$ est également une racine de $f$.
    1. Montrer que l'équation $f(x) = 0$ est équivalente à l'équation
    $$
    (E): 2\left(x^2 + \dfrac{1}{x^2}\right) - 9\left(x + \dfrac{1}{x}\right) + 14 = 0.
    $$
3. On pose $u = x + \dfrac{1}{x}$. Déduire de la question précédente que $(E)$ est équivalente à
    $$
    (E'): 2u^2 - 9u + 10 = 0.
    $$
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"> <span class="exo-extra"> Vraie/Faux </span>
...
1. $f$ est la fonction polynôme définie sur $\mathbb{R}$ par $f(x) = 4x^3 + 2x^2 - 2x - 1$.  
   a. Démontrer que pour tout réel $x$, $f(x) = (2x + 1)(ax^2 + bx + c)$, où $a$, $b$ et $c$ sont des réels à déterminer.  
...
2. $f$ est la fonction polynôme définie sur $\mathbb{R}$ par $f(x) = x^3 - 4x^2 - \dfrac{9}{4}x + 9$.  
   a. Démontrer que pour tout réel $x$, $f(x) = (x - 4)(ax^2 + bx + c)$, où $a$, $b$ et $c$ sont des réels à déterminer.  
   b. Donner le tableau de signe de $f(x)$.
:::
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"></span> <span class="exo-extra"> Extrait DST 2024-2025 </span>
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"></span> <span class="exo-extra"> Kangourou des maths, 2016 </span>
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"></span> <span class="exo-extra"> **À la pêche** 🎣  </span>
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"></span> <span class="exo-extra">  **Convexité de la fonction carré**   </span>
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"></span> <span class="exo-extra"> **À la piscine** 🏊‍♀️    </span>
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"></span> <span class="exo-extra">  **Projet de rampe de skate** 🛹     </span>
...
## Exercice
::: {.bloc .exo}
<span class="exo-num"></span><span class="exo-extra">  Extrait Évaluation    </span>
...
$$y = -\dfrac{g}{2v^2}(1 + \tan^2\theta)x^2 + x \tan\theta$$  
...
2. On pose $\vec{AM} = t\vec{AB}$ et $f(t) = CM^2$.  
   ...
   c. Montrer que $f(t) = 125(t - \dfrac{3}{5})^2 + 20$  
...
1.  
   a. Montrer que $\dfrac{\sqrt{6}}{4}$ est une racine de $P$  
...
1. a. Résoudre l'équation $f(x)=<0$ .
   b. En déduire la position de $\mathscr{C}$ par rapport à l'axe des abscisses.
2. Déterminer la forme canonique de $f$.
...
4. a. Dresser le tableau de variations de $f$.
   b. En déduire, suivant les valeurs du réel $m$, le nombre de solution de l'équation $f(x)=m$.
...
$$f(x) = x^2-3x-1\quad \text{et} \quad g(x) = 1 +\dfrac{2}{x-3}$$  
...
1. Résolution graphique :  
   a. Déterminer graphiquement les solutions de $f(x) = 2$.  
   b. Déterminer graphiquement les solutions de $f(x) = g(x)$.
2. Résolution algébrique :  
   a. Déterminer les antécédents de $-1$ par $f$ et de $1$ par $g$ si ils existent.  
   b. Démontrer que $M(x,y) \in \mathcal{P} \cap \mathcal{H}$ si et seulement si  
   $$
   \dfrac{(x-4)(x^2 -2x -1)}{x-3} = 0
   $$
   c. En déduire les abscisses des éléments de $\mathcal{P} \cap \mathcal{H}$.
   d. En utilisant (1), déterminer les positions relatives de $\mathcal{P}$ et $\mathcal{H}$.
:::
