...
Soit le vecteur $\ve{u}(\alpha \, ; \, \beta)$, où $\alpha = -\frac{b}{2a}$ et $\beta = f(\alpha)$.  
Montrons que $\mathscr{C}_f = t_{\ve{u}}(\mathscr{C}_h)$.


Pour cela, on va montrer deux inclusions :  $\mathscr{C}_f \subset t_{\ve{u}}(\mathscr{C}_h)$ et que $ t_{\ve{u}}(\mathscr{C}_h) \subset \mathscr{C}_f$.
