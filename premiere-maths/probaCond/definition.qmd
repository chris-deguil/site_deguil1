...
\noindent Une expérience aléatoire peut être schématisée par un arbre pondéré dont chaque branche est affectée d'un poids qui est une probabilité.

![](../../image/proba_graphe1.png){style="display:block;margin:0 auto;width:50%;"}
...
2. Construire l'arbre de probabilité associé à la situation  
   <details class="bloc cor"><summary>Afficher la correction</summary>
![](../../image/proba_graphe2.png){style="display:block;margin:0 auto;width:50%;"}
   </details>
