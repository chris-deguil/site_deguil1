...
Cette droite « limite » a un seul point de contact (dans un voisinage proche de $A$) avec $\mathcal{C}_f$. On dit alors que cette droite \og limite \fg est la tangente en $A$ à $\mathcal{C}_f$.
:::
...
&\Longleftrightarrow T_3 \, : \, y = - \frac{2}{27}(x - 3) + \frac{1}{9} \\
&\Longleftrightarrow T_3 \, : \, y = f'(3)(x - 3) + f(3) = -\frac{2}{27}x + \frac{1}{3}
\end{aligned}$$

Donc l'équation cherchée est :  
$T_3 \,:\, y = - \frac{2}{27}x + \frac{1}{3}$$
</details>
:::
