...
11. Dans un editeur python ouvrir le fichier `Application_reseau.py`
...
1.   **Le principe :** Pour recommander un nouvel ami, l'algorithme cherche des personnes situées à une **distance de 2** (les "amis d'amis"). 
