...
<iframe
  src="https://console.basthon.fr/?from=https://raw.githubusercontent.com/chris-deguil/site_deguil1/main/code_python/snt/Application_reseau.py"
...
11. **Le principe :** Pour recommander un nouvel ami, l'algorithme cherche des personnes situées à une **distance de 2** (les "amis d'amis"). 
  ...
  - 
12. 💻 **Manipulation :** Exécutez l'instruction `print(centre(reseau))`.
