...
$$\forall \epsilon >0, \, \exists \delta >0,\, \forall x \in I, (0 \leqslant x - a \leqslant \delta \Rightarrow |f(x)-l| \leqslant \epsilon)$$
:::
...
Alors $$\lim_{x \to 0^+} f(x) = -1 \quad \text{ et } \quad \lim_{x \to 0^-} f(x) = 1$$
...
1\, , \text{ si } x=0
\end{cases}$$
La fonction admet-elle une limite en $1$ ?
