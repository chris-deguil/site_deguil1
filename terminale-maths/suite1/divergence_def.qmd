...
*(Par exemple, en prenant $n_0 = \text{Ent}\left(\sqrt{A - 1}\right) + 1$)*.
...
On pose $N = \max(n_1\,;\,n_2)$, ainsi pour tout entier $n \geqslant N$, on a $u_n \in I$, c'est-à-dire que $A < u_n$ et $u_n \leqslant v_n$. Donc $A < v_n$.
